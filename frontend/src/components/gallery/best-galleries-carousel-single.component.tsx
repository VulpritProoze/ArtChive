...
interface BestGalleriesCarouselSingleProps {
  galleries: GalleryListItem[];
  isLoading: boolean;
}

export const BestGalleriesCarouselSingle = ({ galleries, isLoading }: BestGalleriesCarouselSingleProps) => {
    ...
    return (
      <section className="mb-12">
        ...
        <div className="relative px-4 lg:px-6">
          <div className="card bg-base-100 rounded-xl overflow-hidden shadow-xl transition-all duration-300 relative">
            <div className="relative bg-base-300 overflow-hidden w-full h-96">
  ...
  const gallery = galleries[selectedIndex];
  ...
  return (
    <section className="mb-12">
      ...
      <div className="relative px-4 lg:px-6">
        <div 
          className="card bg-base-100 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 relative"
        ...
        >
          ...
          >
            {/* Full width image */}
            <div className="relative bg-base-300 overflow-hidden w-full h-96 lg:h-96">
              <img
            ...
            <div className="dropdown dropdown-end">
              <button
                ...
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  setShowDropdown(showDropdown === selectedIndex ? null : selectedIndex);
                }}
              >
                ...
                <ul className="dropdown-content menu p-2 shadow-xl bg-base-100 rounded-box w-56 border border-base-300 mt-2 z-50">
                  ...
                  <li>
                    <div title="Coming Soon">
                      <Link
                        to="#"
                        className="gap-3 opacity-50 cursor-not-allowed"
          ...
          <button
            ...
            className="absolute left-4 top-[48%] btn btn-circle btn-lg bg-black/50 backdrop-blur-sm border-0 hover:bg-black/70 text-white z-30"
          ...
          <button
            ...
            className="absolute right-4 top-[48%] btn btn-circle btn-lg bg-black/50 backdrop-blur-sm border-0 hover:bg-black/70 text-white z-30"
