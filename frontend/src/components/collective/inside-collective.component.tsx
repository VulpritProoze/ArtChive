...
import { PostFormModal, CommentFormModal } from '@components/common/modal'
...
const CollectiveHome = () => {
  ...
  const { user, isAdminOfACollective, isMemberOfACollective, fetchCollectiveMemberDetails } = useAuth();
